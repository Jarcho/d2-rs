...
pub(super) const HOOKS: Hooks = Hooks {
  ...
  patches: FeaturePatches::new(
    &[ModulePatches::new(
      ...
      &[
        ...
        Patch::call_c(0xe836, patch_source!("
          ...
          03f0
          8bc6
        "), crate::hooks::v111a::update_menu_char_frame_111_asm_stub),
        // Menu sleep patch
    ...
    &[
      ...
      ModulePatches::new(
        d2::Module::Common,
        &[Patch::call_c(0xe0b7, patch_source!("e884f9ffff"), super::v111a::intercept_teleport_111_asm_stub)],
      ),
    ],
    &[
      ModulePatches::new(
    ...
    &[
      ModulePatches::new(
        d2::Module::Client,
        &[
          Patch::nop(0x81432, patch_source!("
            53
            e828fbffff
          ")),
        ]
