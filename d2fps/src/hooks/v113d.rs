  ...
  patches: FeaturePatches::new(
    ...
    &[ModulePatches::new(
      ...
      &[
        ...
        Patch::call_c_at(0x2770c, patch_source!("
          a1 $007bba6f
          85c0
          7517
          a1 $dcd1bc6f
        ...
        Patch::call_c_at(0x45ea1, patch_source!("
          xxxxxxxxxxxx
          xxxx
          a1 $50d0bc6f
          3bc3
    ...
    &[
      ModulePatches::new(
        d2::Module::Client,
        &[
          Patch::call_c(0xb60f1, patch_source!("e81afcffff"), draw_arcane_bg),
        ],
      ),
    ],
    &[
    ...
    &[
      ModulePatches::new(
        d2::Module::Client,
        &[
          Patch::nop(0x4c082, patch_source!("
            53
            e828fbffff
          ")),
        ]
