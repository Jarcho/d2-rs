  ...
  patches: FeaturePatches::new(
    ...
    &[ModulePatches::new(
      ...
      &[
        ...
        Patch::call_c_at(0x7d1e1, patch_source!("
          xxxxxxxxxxxx
          xxxx
          a1 $d0c3bc6f
          3bc3
    ...
    &[
      ...
      ModulePatches::new(
        d2::Module::Common,
        &[Patch::call_c(0x4b467, patch_source!("e894faffff"), super::v111a::intercept_teleport_111_asm_stub)],
      ),
    ],
    &[
      ModulePatches::new(
        d2::Module::Client,
        &[
          Patch::call_c(0xbb701, patch_source!("e81afcffff"), draw_arcane_bg),
        ],
      ),
    ],
    &[
      ModulePatches::new(
        ...
        &[
          ...
          Patch::call_c(0xbafbc, patch_source!("
            03da
            8bc3
            3bc7
