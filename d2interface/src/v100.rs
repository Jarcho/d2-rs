...
pub const ADDRESSES: Addresses = Addresses {
  ...
  max_weather_particles: 0x12eae0,
  weather_angle: 0x12eacc,
  rain_speed: 0x12eab8,
  is_snowing: 0x12eb80,
  sine_table: 0x24b6c,
  // Signature: fastcall(&mut Rng)
  gen_weather_particle: 0xd7c0,
...
pub mod dtbl {
  ...
  pub struct NpcAnimDef {
    pub name: [u8; 32],
    pub token: I32Code,
    pub direction_count: ByNpcState<u8>,
  }
  ...
  pub struct ObjDef {
    ...
    pub light_size: ByObjState<u8>,
    pub block_light: ByObjState<u8>,
    pub can_collide: ByObjState<u8>,
    pub is_attackable: u8,
    pub start_frame: ByObjState<u8>,
    pub draw_order: ByObjState<u8>,
    pub env_effect: u8,
    pub is_door: u8,
    pub blocks_vis: u8,
    pub orientation: u8,
